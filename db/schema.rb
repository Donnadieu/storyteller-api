...
ActiveRecord::Schema[7.0].define(version: 20_231_109_112_504) do
  ...
  create_table 'flipper_features', force: :cascade do |t|
    ...
    t.index ['uuid'], name: 'index_flipper_features_on_uuid', unique: true
  end
  ...
  create_table 'flipper_gates', force: :cascade do |t|
    ...
    t.index ['uuid'], name: 'index_flipper_gates_on_uuid', unique: true
  end
